...
5. 전자금융업자 클라우드 이용 신고·보고 의무 — AWS/GCP를 쓰는 PG·선불사가 놓치기 쉬운 것
6. PG/선불 사업에 필요한 최소 시스템 구성 — 원장, 정산 배치, 리스크 엔진, 감사로그 아키텍처
7. AWS 기반 결제 인프라 설계 — 가용성·이중화·재해복구(멀티 AZ/리전) 관점에서 결제 시스템이 요구하는 것
